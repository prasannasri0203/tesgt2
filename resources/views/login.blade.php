            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 col-xs-12 col-sm-12 login-right login-top">
                        <div class="div-note">
                            <b>NOTE:</b><p> New Zakah users or Zakah users who created their accounts more than 12 months ago must register and go through the online verification process by first clicking on the REGISTER button below. By continuing this process you agree to the terms of our privacy policy found <a href={{url("/privacyPolicy")}}>HERE</a>.</p>
                        </div>
                        <div class="login-wrap">
                            <h2 class="login-gd">Login</h2>
                            <p class="login-sub">Login to continue using your account</p>
                            ...
                            @endif
                            <form id="doLogin" action="{{ url('/doLogin') }}" method="POST" >
                            @csrf
                            ...
                            <h2 class="label-txt">Password</h2>
                            <div class="login-bx">
                                ...
                                <input type="password" name="password" class="l-txt-bx" value="" placeholder="|Enter Password" id="psw-bx" autocomplete="nope">
                                ...
                                @enderror
                                <br><br>
                                <div class=""><a href="{{url('forgetPassword')}}">Forget Password</a></div>
                            ...
                            <button class="login-btn-g login" type="submit">LOGIN</button>
                           </form>
                           <div class="dha">
                            <h2 class="hav-txt-g">Don’t have an account?</h2> <br>
                            <button class="login-btn-g btn-btn register" >REGISTER</button>
                           </div>
                        </div>
                    </div>
                </div>
